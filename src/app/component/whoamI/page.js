    ...
    return (
        <div className="flex flex-col items-start justify-start p-8 min-h-screen m-16 mt-36 font-sans ">
            ...
            <motion.p
                ...
                viewport={{ once: true }}
            >
                For me, technology is more than just a career—it’s a canvas where creativity and logic come together to solve real-world problems and create impactful experiences.</motion.p>
        </div>
    );
}
